...
let GaugesService = require('../../../services/GaugesService');
let asyncWrapper = require('../../../util/asyncWrapper').AsyncWrapper;

let gaugesService = new GaugesService();
// +++++++++++++++++++++++++++++++++++++++++ All Data +++++++++++++++++++++++++++++++++++++++++++++
router.route('/all').get(asyncWrapper(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /* yield*/, gaugesService.findAllSites()];
          case 1:
            data = _a.sent();
...
router.get('/info', asyncWrapper(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /* yield*/, gaugesService.findAllReadings()];
          case 1:
            data = _a.sent();
            res.status(200).json(data);
            return [2 /* return*/];
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              gaugesService.findReadingsBySiteCode(siteCodeId),
            ];
          case 1:
            gaugeData = _a.sent();
