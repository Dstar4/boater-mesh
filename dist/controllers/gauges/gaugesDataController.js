...
// ****************************** Site Data *********************************
router.get("/sites", asyncWrapper(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var data;
...
// ****************************** Reading Data ******************************+
router.get("/readings", asyncWrapper(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var allSitesData;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
router.post("/sites", asyncWrapper(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
